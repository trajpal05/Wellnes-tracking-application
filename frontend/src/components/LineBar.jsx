...
const LineBar = () => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto bg-white rounded-lg dark:bg-gray-800 p-4 md:p-6 text-left  shadow">
      <h5 className="text-xl font-bold leading-none text-gray-900 dark:text-white p-5">Activity Trend</h5>
      ...
      <hr className="my-4 border-gray-300 dark:border-gray-700" /> {/* Horizontal line */}
